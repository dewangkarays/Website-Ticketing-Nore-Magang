...
<body>
    <main>
        ...
        <table class="main-table desc-table" style="margin-top: 15px;line-height: 0.99;">
            <tr>
                <th align="left" style="width: 20%; height: 20px" class="nore-fontcolor">PROYEK</th>
                <th align="left" style="width: 60%; height: 20px" class="nore-fontcolor">DESKRIPSI</th>
        ...
        @endif
            ...
            <table @if ($page_break) style="margin-top: 0cm" @else style="margin-top: 2cm" @endif>
                <tr>
                    ...
                    <th align="center" style="font-size: 10px; font-weight: normal; width:auto; margin-left:6px">Semarang, {{ date('d') }} {{ config('custom.bulan.' .date('n')) }} {{ date('Y') }}</th>
                </tr>
                <tr>
                    <td align="left" style="vertical-align: top;">
