                    ...
                    <fieldset class="mb-3">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                ...
                                @else
                                    <label class="col-form-label col-lg-10">{{$rekapdp->nama}}</label>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                <label class="col-form-label col-lg-10">{{$rekapdp->nama_tertagih}}</label>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                <label class="col-form-label col-lg-10">Rp @angka($rekapdp->total)</label>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                <label class="col-form-label col-lg-10">Rp @angka($rekapdp->jml_terbayar)</label>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-10">
                                <label class="col-form-label col-lg-10">{{date('d F Y', strtotime($rekapdp->jatuh_tempo))}}</label>
                            </div>
                        </div>
