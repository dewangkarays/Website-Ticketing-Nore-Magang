...
<div class="page-header page-header-light">
    ...
    <div class="content">
        ...
        <div class="card">
            ...
            <form class="form-validate-jquery" action="{{url('/rekapdptagihan/lampiran/'.$rekapdp->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
            ...
            <table class="table datatable-basic table-hover">
                ...
                <tbody>
                    ...
                    <tr> 
                        ...
                        <td align="center">
                            <button class="btn btn-danger btn-lg delbutton" data-toggle="modal" data-target="#modal_theme_danger" data-uri="{{url('/rekapdptagihan/lampirandestroy/'. $lampiran->id,$rekapdp->id)}}"><i class="icon-x"></i> Delete</button>
                        </td>
                    </tr>
                    @php ($i++)
                    @endforeach
