    ...
    <div class="wrapper">
      ...
      <div class="container">
        ...
        <div class="data-antrian">
          ...
          {{-- <br><br> --}}
          @if ($premiumproyek>0)
            <h5 style="margin-top:1rem; font-weight:bold;">Antrian Premium</h5>
            <div id="table_data">
              ...
              <table id="table_id">
                ...
                <tr>
                  <th scope="row" style="text-align:center;">{{$i}}</th>
                      ...
                      @endif</td>
                      <td style="text-align:center;">
                        @if ($antrianp->severity == 1)
                          <p>Low</p>
                        @elseif ($antrianp->severity == 2)
                          <p>Normal</p>
                        @elseif($antrianp->severity == 3)
                          <p>High</p>
                        @else
                          <p>Tidak ditemukan</p>
                        @endif
          ...
          @if ($otherproyek>0)
            <h5 style="margin-top:1rem; font-weight:bold;">Antrian Non Premium</h5>
              <div id="table_data">
                <div class="table-responsive">
                <table id="table_id">
                  <thead class="table-success">
