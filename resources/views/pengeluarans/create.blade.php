				...
				<form class="form-validate-jquery" action="{{ route('pengeluarans.store')}}" method="post">
					...
					<fieldset class="mb-3">
                        ...
                        <div class="form-group row">
							...
							<div class="col-lg-10">
								<input name="tgl_pengeluaran" type="text" class="form-control pickadate-accessibility" placeholder="Tanggal Pengeluaran" required>
							</div>
                        </div>
                        ...
                        <div class="form-group row">
							...
							<div class="col-lg-10">
								<input name="nama_pengeluaran" type="text" class="form-control" placeholder="Nama Pengeluaran" required>
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-lg-10">
								<input type="number" min="0" name="nominalp" class="form-control border-teal border-1" placeholder="Nominal" required>
							</div>
						</div>
						<div class="form-group row">
